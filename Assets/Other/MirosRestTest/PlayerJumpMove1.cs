...
public class PlayerJumpMove1 : MonoBehaviour
{
    //-PUBLIC ATTRIBUTES-
    //---------------------------------------------------------------------------------------------
    /*
    ...
    * This is why most variables are changed here (i tried to follow internet-advice)
    */
    void Update()
    {
        ...
        {
            //Make sure falling-animation isn't playing
            playerAnim.SetBool("isFalling", false);

            //Update which movement-direction player is pressing
            moveInput = Input.GetAxisRaw("Horizontal");

            AnimateWalkIfWalking();
    ...
    /*
     *According to internet changes to player movement etc. should be done in FIXED update, 
     * So I tried to put all changes to Plonk's movement here.
     */
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            amountOfBounces++;
            Debug.Log("bounceCount: " + amountOfBounces);
            shouldBounce = true;
    ...
    private void HandleIfLandedAfterJump()
    {
    ...
    private void AnimateWalkIfWalking()
    {
